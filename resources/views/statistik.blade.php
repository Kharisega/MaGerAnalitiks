...
<body class="antialiased bg-gray-100 dark:bg-gray-900 sm:pt-0 text-white">
    <div class="container">
        @php
        ...
        <center class="py-4">
            <h4>Statistik Malam Golden Match Fish</h4>
        </center>
        {{-- @if ($errors->any())
    ...
    <div class="col">
        ...
        <div class="row">
            <div class="col">
                <div class="row">
                    <a href="{{ route('matchFish_index') }}" class="btn btn-danger mr-5" style="position:absolute; top: 10px;">Kembali</a>
                </div>
                <div class="row">
                    <form action="{{ route('matchFish_filter') }}" style="position:absolute; left:800px; top:10px;" method="POST">
                        @csrf
                        <div class="row row-md-5">
                            <div class="col col-md-6">
                                <input type="date" name="date" class="form-control" id="tglcekin" style="width: 180px;" placeholder="checkin">
                            </div>
